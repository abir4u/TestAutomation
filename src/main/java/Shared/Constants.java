...
public class Constants {
    ...
    public static final String kiwiSaverMemberContribution = "You can choose to contribute a regular amount equal to 3%, 4%, 6%, 8% or 10% of your before-tax salary or wage. If you do not select a rate, your rate will be 3%.";
    public static final String kiwiSaverBalance = "If you do not have a KiwiSaver account, then leave this field blank.";
    public static final String voluntaryContributions = "If you are 'Self-Employed' or 'Not employed', you can make direct contributions to your KiwiSaver account. If you are 'Employed', you can make voluntary contributions in addition to your regular employee contributions.";
    public static final String riskProfile = "The risk profile affects your potential investment returns:\n" +
            "\n" +
